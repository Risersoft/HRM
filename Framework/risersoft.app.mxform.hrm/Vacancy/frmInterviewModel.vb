...
<DataContract>
Public Class frmInterviewModel
    Inherits clsFormDataModel

    Protected Overrides Sub InitViews()
        myView = Me.GetViewModel("InterviewFB")
    End Sub
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        sql = "Select * from Interview where Interviewid = " & prepIDX
        Me.InitData(sql, "", oView, prepMode, prepIDX, strXML)

        sql = "Select InterviewFBID, InterviewID, InterviewerUserID, Rating, Remark from InterviewFB where InterviewID = " & frmIDX
