    ...
    <form action="" method="post" name="userform" ng-controller="CompanyController">
        ...
        <div Class="form-horizontal">
            <div class="row cbackgroun">
                ...
                <div class="col-md-8"><label class="control-label lbln">Advance</label></div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped space10">
                            ...
                            <tr ng-repeat="row in AttTagMstr">
                                ...
                                <td><label>{{row.Last3MnthAttAvg}}</label></td>
                                <td><label>{{row.AdvAttAvg}}</label></td>
                                <td><label>{{row.AdvReq}}</label></td>
                                <td><label>{{row.Advance}}</label></td>
                                <td><label>{{row.PaymentThruCodeAdv}}</label></td>
    ...
    <script type="text/javascript">
        ...
        rsApp.controller('CompanyController', function ($scope,$http) {
            ...
            var loadmodel = function (result) {
                ...
                $scope.AttTagMstr = $scope.model.GridViews.AdvTDS.MainGrid.myDS.dt;
