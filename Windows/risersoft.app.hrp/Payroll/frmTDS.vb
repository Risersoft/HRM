...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Panel4.Size = New System.Drawing.Size(512, 48)
        ...
        Me.btnSave.Location = New System.Drawing.Point(224, 8)
        ...
        Me.btnOK.Location = New System.Drawing.Point(416, 8)
        Me.btnOK.Name = "btnOK"
        ...
        Me.lblName.Size = New System.Drawing.Size(512, 48)
        ...
        Me.UGridAtt.Size = New System.Drawing.Size(512, 405)
        ...
        Me.ClientSize = New System.Drawing.Size(512, 501)
...
#End Region
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        If prepMode = EnumfrmMode.acEditM Then
            ...
            Me.lblName.Text = "TDS for " & ds.Tables(0).Rows(0)("descrip")
            ...
            '     sql = "SELECT payslipid, isfinal, Code, [Name], Dep, TDS from hrplistadvtds() " & _
            '    myUtils.CombineWhere(True, "payperiodid=" & frmIDX, myAssy.WValue(pView, "id2casual,dep,isworker")) & " order by [Code] "

            myView.mainGrid.myCMain.QuickConf(sql, True, "1-4-2-2", True)
            str = "<BAND INDEX=""0"" TABLE=""payslip"" IDFIELD=""payslipid"" ><COL KEY=""TDS""/></BAND>"
